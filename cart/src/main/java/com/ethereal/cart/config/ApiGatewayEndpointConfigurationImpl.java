package com.ethereal.cart.config;
...
public class ApiGatewayEndpointConfigurationImpl implements ApiGatewayEndpointConfiguration {
    ...
    @Override
    public void initMap() {
        endpointList.add(new Endpoint("/api/v1/cart", HttpMethod.GET, Role.GUEST));
        endpointList.add(new Endpoint("/api/v1/cart", HttpMethod.POST, Role.GUEST));
        endpointList.add(new Endpoint("/api/v1/cart", HttpMethod.DELETE, Role.GUEST));
    }
